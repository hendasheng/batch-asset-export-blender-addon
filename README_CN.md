...
- [Releases 下载](https://github.com/hendasheng/batch-asset-export-blender-addon/releases)
...
- 请下载 Release 页面里的安装包，不要下载 GitHub 自动生成的源码压缩包
